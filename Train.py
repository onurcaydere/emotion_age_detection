...
checkpointer=ModelCheckpoint(filepath=kaydetme_yolu+"face_model1.h5",verbose=1,save_best_only=True)
epochs=50
batchSize=100
...
with open(kaydetme_yolu+"modelDeneme2.json",'w') as json_file:
